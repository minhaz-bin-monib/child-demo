...
const Maindashboard = () => {
    ...
    return (
            ...
            <section className="dashboard_main_section">
                ...
                <Link to="/main"><img src={imglogo} alt="" className='img-fluid mt-3' /></Link>
                        ...
                        <li>
                            <div className="py-2">
                                <a className="" onClick={() => setToggle(toggle => !toggle)}>
                                    ...
                                    <div>
                                        <Link to="/deleteNurse"><p>Babysitter</p></Link>
                                    </div>
                                    

                                    <div class="list_icon">
                                        <IoIosArrowDown size='1.6rem' style={{paddingBottom:'1px', paddingLeft:'4px'}}></IoIosArrowDown>
                                ...
                                <div class="list_icon">
                                    ...
                                    <div>
                                        <Link to="/deleteNurse"><p>Add</p></Link>
                                    </div>
                                </a>
                                </div>
                            </div>
