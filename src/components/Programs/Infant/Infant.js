            ...
            <section className="main_section container">
                <div className="row">
                    <div className='main_div'>
                        <h2 className='mt-5  text-center'>Infant Program (0-1 year old)</h2>

                        <h3 className='mb-3 mt-3'>Infant Daycare: Details of Little Scholars Program</h3>

                        <p className=' mt-3'>Every mother and father wants to see their child as a healthy, well-mannered, sociable person. When parents look for infant daycare near me, they choose Little Scholars because of several reasons:</p>
                        ...
                        <h3 className='mb-3 mt-3'>Infant classroom</h3>
                        <p>
                            In our daycare, we try to prepare children not only for school but for life in society. We give them freedom and teach them to get along with each other from an early age. The environment for infants is vital in this process. So, we pay attention to all the details around your baby.
                            <br />
                            <br />
                            Be careful looking for a “day care nursery near me” for kids’ growth and development. It is a second home for an infant, it should be warm and cozy. We keep all the most important recommendations at Little Scholars:
                        </p>
                        ...
                        <ol className='mb-3 mt-3'>
                            ...
                            <li>The furniture is made of comfortable, durable, and eco-friendly materials to keep infants safe.</li>
                        ...
                        <h3>Infant curriculum</h3>
                        <p>Our daycare is an environment for a child to grow and develop with attention and professional care, studying according to unique programs. Little Scholars nursery will be the best infant care near me when you look for such a place!
                            <br />
                            <p>The child has just been born but in a few months, his motor skills will reach a high level of development. Learning with us, your baby will surely please parents with achievements. By their first birthday, the infant will be able to:</p>
                        ...
                        <p>In the first year of life, babies learn fundamental things like interaction with the world and sharing emotions. The creative teachers in the baby childcare near me that you are trying to find will help with it!
                            ...
                            Infants enjoy playing with mazes and blocks. When kids are interested in the difficulties, they practice problem-solving skills. <br />
